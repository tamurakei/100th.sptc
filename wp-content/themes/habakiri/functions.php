...
function my_scripts_method() {
  	wp_enqueue_script('jquery.equalheight.js', get_settings('site_url').'/wp-content/themes/habakiri/js/jquery.equalheight.js', array('jquery'), '1.0.1', false);
//        wp_enqueue_script('jquery.tile.js', get_settings('site_url').'/wp-content/themes/habakiri/js/jquery.tile.js', array('jquery'), '1.0.0', false);
}
...
class Habakiri_Base_Functions {
	...
	public function register_sidebar() {
		...
		register_sidebar( array(
			'name'          => __( 'Search', 'habakiri' ),
			'id'            => 'search-widget-area' ,
			'before_widget' => '<div class="data-search">',
			'after_widget'  => '</div>',
			'before_title'  => '<div>',
			'after_title'   => '</div>',
		) );
...
<!-- -->
					<?php echo $post->ID;//apply_filters( 'habakiri_no_thumbnail_text', get_the_time( 'd' ) ); ?>
<!-- -->
				</span>
			<?php endif; ?>
		</a>

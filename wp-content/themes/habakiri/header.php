	...
	<header id="header" class="header <?php echo esc_attr( implode( ' ', $header_classes ) ); ?>">
		...
		<div class="container">
			<div class="row header__content">
				<div class="col-md-12 col-xs-12 <?php echo esc_attr( $site_branding_size ); ?> header__col">
					<?php get_template_part( 'modules/site-branding' ); ?>
				<!-- end .header__col --></div>
				
					<div class="col-sm-2 visible-sm <?php echo esc_attr( $gnav_size ); ?> header__col global-nav-wrapper clearfix">

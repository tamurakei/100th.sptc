...
Tags: pdf, thumbnail, image, jpg, png, upload, embed, viewer, convert, attachment
...
<li>...(And Your Custom File Sizes)</li></ul></li></ul></li></ul>
...
== ChangeLog ==
= 1.4.5 =
Add overriding wp_get_attachment_metadata function. Add Åethumb-of-pdfÅf class to a PDF thumbnail via wp_get_attachment_image. Fixed a conflict with changing media-frame-menu of wp.media editor.
